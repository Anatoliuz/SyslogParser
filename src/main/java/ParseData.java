...
// */
//public class ParseXML implements Closeable {
...
//     */
//    public ParseXML(InputStream in) {
//        this(in, true, "UTF-8");
//    }
//
//    /**
...
//     */
//    public ParseXML(InputStream in, boolean parseTag, String encoding) {
//        this.in = in;
...
//                getEventPriorityBySyslog(priority),
//                0,
//                hostname,
//                fields);
//    }
...
//            case 1:
//            case 2:
//                return Event.Priority.FATAL;
//            case 3:
//                return Event.Priority.ERROR;
//            case 4:
//                return Event.Priority.WARN;
//            case 5:
//            case 6:
//                return Event.Priority.INFO;
//            case 7:
//                return Event.Priority.DEBUG;
//            default:
...
//
//
////        Scanner in = new Scanner(new FileReader("in.log"));
...
////        Scanner scanner = new Scanner( new File("in.log"), "UTF-8" );
////        String text = scanner.useDelimiter("\\A").next();
////       SyslogParser myParser = new SyslogParser();
////        Charset charset=Charset.forName("UTF8");
////        Event event = myParser.parseMessage(text, charset );
////
////        Map<String, String> ap = event.getHeaders();
////
...
////                xpath.compile("/System/EventID[text()=400]" );
